...
import SystemNotificationPanel from "@/(components)/system_admin_components/common/SystemNotificationPanel";
...
const switchTitle: Record<string, string> = {
  ...
  "/system_admin/users": "Users",
  "/system_admin/manage-tiers": "Manage Tiers",
  "/system_admin/support-ticket": "Support Ticket",
  "/system_admin/profile": "Profile",
};

export default function SystemHeader({ setSidebarOpen }: HeaderProps) {
    ...
    <header className="h-[72px] md:h-[90px] w-full bg-white border-b border-[#EDEFF2] flex items-center justify-between px-6 md:px-8 sticky top-0 z-[120]">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div className="relative" ref={notifRef}>
          ...
          {showNotif && (
            <SystemNotificationPanel onClose={() => setShowNotif(false)} />
          )}
        </div>
